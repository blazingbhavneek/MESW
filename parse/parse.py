...
class DocxExtractor:
        ...
        for element in self.doc.element.body:
            if isinstance(element, CT_P):
                ...
                if is_head:
                    ...
                    headings_map[normalized] = (current_section, current_section_name, level)
    ...
    def identify_heading_in_text(self, text: str, headings_map: Dict) -> Tuple[bool, int, int, str]:
        """
    ...
    def process_pages_with_hierarchy(self, pages: List[Dict], headings_map: Dict) -> List[Dict]:
        """
        ...
        for page_data in pages:
            ...
            for line in lines:
                ...
                is_head, section, level, section_name = self.identify_heading_in_text(line, headings_map)
